...
<?php endif; ?>
<?php echo $__env->make('Job::frontend.layouts.details.hotel-rooms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="g-rules">
    ...
    <div class="description">
        ...
        <?php if($translation->policy): ?>
            <div class="row">
                <div class="col-lg-4">
                    <div class="key"><?php echo e(__("Job Policies")); ?></div>
                </div>
                <div class="col-lg-8">
...
<?php if ($__env->exists("Job::frontend.layouts.details.hotel-surrounding")) echo $__env->make("Job::frontend.layouts.details.hotel-surrounding", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<div class="bravo-hr"></div>
...
<?php endif; ?>
<div class="bravo-hr"></div>
<?php /**PATH D:\Web\Laravel\newpro\package\modules/Job/Views/frontend/layouts/details/hotel-detail.blade.php ENDPATH**/ ?>
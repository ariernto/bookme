        ...
        <div class="col-md-9">
            ...
            <div class="control-action">
                ...
                <?php if(!empty($recovery)): ?>
                    <a href="<?php echo e(route("hotel.vendor.restore",[$row->id])); ?>" class="btn btn-recovery btn-light" data-confirm="<?php echo e(__('"Do you want to recovery?"')); ?>"><?php echo e(__("Recovery")); ?></a>
                <?php endif; ?>
                <?php if(Auth::user()->hasPermissionTo('hotel_update')): ?>
                    <a href="<?php echo e(route("hotel.vendor.edit",[$row->id])); ?>" class="btn btn-light"><?php echo e(__("Edit")); ?></a>
                <?php endif; ?>
                <?php if(Auth::user()->hasPermissionTo('hotel_delete')): ?>
                    <a href="<?php echo e(route("hotel.vendor.delete",[$row->id])); ?>" class="btn btn-danger" data-confirm="<?php echo e(__('"Do you want to delete?"')); ?>>"><?php echo e(__("Delete")); ?></a>
                <?php endif; ?>
                <?php if($row->status == 'publish'): ?>
                    <a href="<?php echo e(route("hotel.vendor.bulk_edit",[$row->id,'action' => "make-hide"])); ?>" class="btn btn-light"><?php echo e(__("Make hide")); ?></a>
                <?php endif; ?>

                ...
                <div class="form-wrapper">
                    ...
                    <form action="<?php echo e(route('review.store')); ?>" class="needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            ...
                            <?php if($tour_review_stats = setting_item("space_review_stats")): ?>
...
<?php endif; ?>
<?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Space/Views/frontend/layouts/details/space-review.blade.php ENDPATH**/ ?>
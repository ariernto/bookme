<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Sauna Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the sauna")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="duration" class="form-control" value="<?php echo e($row->duration); ?>" placeholder="<?php echo e(__("Ex: 3")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Start Time")); ?></label>
                        <input type="text" name="start_time" class="form-control" value="<?php echo e($row->start_time); ?>" placeholder="<?php echo e(__("Ex: 19:00")); ?>">
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Sauna/Views/admin/sauna/content.blade.php ENDPATH**/ ?>
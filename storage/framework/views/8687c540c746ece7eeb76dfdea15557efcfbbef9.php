    ...
    <div class="container-fluid">
        <div class="d-flex mb20">
            ...
            <div class="title-actions ml-2">
                ...
                <a href="<?php echo e(route('tour.admin.create')); ?>" class="btn btn-sm"><?php echo e(__("+ Add new tour")); ?></a>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('tour.admin.edit',['id'=>$row->id])); ?>" class="btn"><i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                    </tr>

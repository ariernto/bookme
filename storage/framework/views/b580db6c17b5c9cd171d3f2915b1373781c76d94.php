<div class="bravo_filter">
    <form action="<?php echo e(url(app_get_locale(false,false,'/').config('activity.activity_route_prefix'))); ?>" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($activity_min_max_price[0]) );
                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($activity_min_max_price[1]) );
        ...
        <div class="g-filter-item">
            <div class="item-title">
                <h3><?php echo e(__("Activity Type")); ?></h3>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                ...
                <?php if(count($activity_category) > 3 and empty($current_category_ids)): ?>
...
<?php /**PATH D:\Web\Laravel\VarghaJob\bookme\modules/Activity/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>
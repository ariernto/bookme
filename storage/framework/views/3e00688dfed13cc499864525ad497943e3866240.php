<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Accommodation Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the accommodation")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php endif; ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Accommodation/Views/admin/accommodation/content.blade.php ENDPATH**/ ?>
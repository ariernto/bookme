                ...
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th width="130px"> <?php echo e(__('Company')); ?></th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="<?php echo e(route('job.admin.edit',['id'=>$row->id])); ?>"><?php echo e(__("Edit hotel")); ?></a>
                                                <a class="dropdown-item" href="<?php echo e(route('job.admin.room.index',['hotel_id'=>$row->id])); ?>"><?php echo e(__("Manage Rooms")); ?></a>
                                                <a class="dropdown-item" href="<?php echo e(route('job.admin.room.availability.index',['hotel_id'=>$row->id])); ?>"><?php echo e(__("Manage Rooms Availability")); ?></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>

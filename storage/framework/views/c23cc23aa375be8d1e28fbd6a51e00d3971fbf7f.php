<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the event")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php /**PATH D:\Web\Laravel\newpro\package\modules/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>
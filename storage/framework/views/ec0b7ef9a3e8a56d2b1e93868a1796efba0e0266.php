...
<div class="bravo-form-search-all" style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('<?php echo e($bg_image_url); ?>') !important;height:500px">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<?php /**PATH D:\Web\Laravel\VarghaJob\bookme\modules/Template/Views/frontend/blocks/form-search-all-service/index.blade.php ENDPATH**/ ?>
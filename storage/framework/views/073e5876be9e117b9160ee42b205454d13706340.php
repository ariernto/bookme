<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the space")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php endif; ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Space/Views/admin/space/content.blade.php ENDPATH**/ ?>
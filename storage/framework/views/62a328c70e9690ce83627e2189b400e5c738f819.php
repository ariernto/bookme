<div class="panel border shadow">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Tour title")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group-item">
            ...
            <div class="text-right">
                <span class="btn btn-danger btn-sm btn-add-item"><i class="icon ion-ios-add-circle-outline"></i> <?php echo e(__('Add item')); ?></span>
            </div>
...
<?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>
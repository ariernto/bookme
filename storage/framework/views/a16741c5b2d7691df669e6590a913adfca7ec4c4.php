...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex align-items-center mb40">
            ...
            <div class="title-actions ml-3">
                <a href="<?php echo e(url('admin/module/news/create')); ?>" class="btn btn-sm"><small><?php echo e(__("+ ADD NEW")); ?></small></a>
            </div>
        </div>
            ...
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/news/bulkEdit')); ?>"
                        ...
                        <select name="action" class="form-control form-control-lg">
                            <option value=""><?php echo e(__(" Bulk Actions ")); ?></option>
                            <option value="publish"><?php echo e(__(" Publish ")); ?></option>
                            <option value="draft"><?php echo e(__(" Move to Draft ")); ?></option>
                            <option value="delete"><?php echo e(__(" Delete ")); ?></option>
                        </select>
                        <button data-confirm="<?php echo e(__("Do you want to delete?")); ?>" class="btn-danger btn btn-lg btn-icon rounded dungdt-apply-form-btn" type="button"><?php echo e(__('APPLY')); ?></button>
                    </form>
                <?php endif; ?>
            </div>
            <div class="col-left">
                <form method="get" action="<?php echo e(url('/admin/module/news/')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <select name="cate_id" class="form-control form-control-lg">
                    ...
                    <button class="btn-danger btn btn-danger btn-icon rounded btn_search" type="submit"><?php echo e(__('SEARCH')); ?></button>
                </form>
            </div>
        </div>
                                ...
                                <?php if($rows->total() > 0): ?>
                                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('news.admin.edit',['id'=>$row->id])); ?>" class="btn btn-sm"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Work/works/tjdjoko/Vargha-Booking/codes/booking-core/modules/News/Views/admin/news/index.blade.php ENDPATH**/ ?>
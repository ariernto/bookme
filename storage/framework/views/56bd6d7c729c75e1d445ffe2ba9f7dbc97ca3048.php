            ...
            <div id="cdn-browser" class="cdn-browser d-flex flex-column" v-cloak :class="{is_loading:isLoading}">
                <div class="files-nav flex-shrink-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-right">
                            ...
                            <button class="btn text-info btn-pick-files">
                ...
                <div class="browser-actions d-flex justify-content-between flex-shrink-0" v-if="selected.length">
                    ...
                    <div class="col-right" v-show="selected.length">
                        <button class="btn btn-info" :class="{disabled:!selected.length}" @click="sendFiles"><?php echo e(__("Use file")); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /Volumes/Work/works/tjdjoko/Vargha-Booking/codes/booking-core/modules/Media/Views/browser.blade.php ENDPATH**/ ?>
<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the hotel")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
</div><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Hotel/Views/admin/hotel/content.blade.php ENDPATH**/ ?>
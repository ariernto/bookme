...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Activity")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('activity.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new activity")); ?></a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/activity/bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(!empty($recovery) ? route('activity.admin.recovery') : route('activity.admin.index')); ?>" class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    <?php if(!empty($rows) and $activity_manage_others): ?>
                        <?php
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/activity/edit/'.$row->id)); ?>"><?php echo e($row->title); ?></a>
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('activity.admin.edit',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Work/works/tjdjoko/Vargha-Booking/codes/booking-core/modules/Activity/Views/admin/index.blade.php ENDPATH**/ ?>
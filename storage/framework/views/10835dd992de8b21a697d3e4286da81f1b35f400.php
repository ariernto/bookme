    ...
    <div class="container">
        <div class="d-flex mb20">
            ...
            <div class="title-actions ml-2">
                <a href="<?php echo e(route('page.admin.create')); ?>" class="btn btn-sm"><?php echo e(__('+ Add new page')); ?></a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
               <form method="get" action="<?php echo e(url('/admin/module/page/')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                    ...
                    <button class="btn-danger btn btn-icon btn_search"  type="submit"><?php echo e(__('Search Page')); ?></button>
                </form>
            </div>
        </div>
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('page.admin.edit',['id'=>$row->id])); ?>" class="btn btn-sm"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Page/Views/admin/index.blade.php ENDPATH**/ ?>
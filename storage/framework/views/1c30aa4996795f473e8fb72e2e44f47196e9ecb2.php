<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo e($translation->title); ?>" placeholder="<?php echo e(__("Name of the boat")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php endif; ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Boat/Views/admin/boat/content.blade.php ENDPATH**/ ?>
    ...
    <form action="<?php echo e(route('news.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post" class="dungdt-form">
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-danger btn-sm rounded" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("View Post")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <button class="btn btn-danger rounded" type="submit"><i class="fa fa-save"></i> <?php echo e(__('Save Changes')); ?></button>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Work/works/tjdjoko/Vargha-Booking/codes/booking-core/modules/News/Views/admin/news/detail.blade.php ENDPATH**/ ?>
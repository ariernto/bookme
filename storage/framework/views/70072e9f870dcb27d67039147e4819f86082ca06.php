<div class="item">
    <a href="<?php echo e(route("job.search",['_layout'=>'map'])); ?>"><?php echo e(__("Show on the map")); ?></a>
</div>
<div class="item">
    <?php
        $param = request()->input();
...
</div><?php /**PATH D:\Web\Laravel\newpro\package\modules/Job/Views/frontend/layouts/search/orderby.blade.php ENDPATH**/ ?>
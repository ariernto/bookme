<form action="<?php echo e(route("hotel.search")); ?>" class="form bravo_form" method="get">
    ...
    <div class="g-button-submit">
        <button class="btn btn-primary btn-dark-red btn-search" type="submit"><?php echo e(__("Search")); ?></button>
    </div>
</form><?php /**PATH /Volumes/Work/works/tjdjoko/Vargha-Booking/codes/booking-core/modules/Hotel/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>
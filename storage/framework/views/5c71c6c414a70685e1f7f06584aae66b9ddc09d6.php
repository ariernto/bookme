...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel mb-5 rounded-lg shadow">
                    <div class="panel-title d-flex justify-content-between align-items-center p-4">
                        <strong><?php echo e(__('Earning statistics')); ?></strong>
                        <div id="reportrange" class="rounded-lg border" style="cursor: pointer; padding: 10px 15px;">
                ...
                <div class="panel rounded-lg shadow">
                    <div class="panel-title d-flex justify-content-between p-4">
            ...
            <?php if(!empty($top_cards)): ?>
                <div class="col-md-4">            
                    <?php $__currentLoopData = $top_cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="dashboard-report-card card rounded-lg shadow">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/Dashboard/Views/index.blade.php ENDPATH**/ ?>
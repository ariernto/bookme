            ...
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/news/bulkEdit')); ?>"
                        ...
                        <button data-confirm="<?php echo e(__("Do you want to delete?")); ?>" class="btn-danger btn btn-icon rounded dungdt-apply-form-btn" type="button"><?php echo e(__('APPLY')); ?></button>
                    </form>
                <?php endif; ?>
            </div>
            <div class="col-left">
                <form method="get" action="<?php echo e(url('/admin/module/news/')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <button class="btn-danger btnbtn-danger btn-icon rounded btn_search" type="submit"><?php echo e(__('SEARCH')); ?></button>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cdjofzdd/test.booking.dorica.fi/modules/News/Views/admin/news/index.blade.php ENDPATH**/ ?>
<div class="bravo_filter">
    <form action="{{url(app_get_locale(false,false,'/').config('activity.activity_route_prefix'))}}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                ...
                @if(count($activity_category) > 3 and empty($current_category_ids))

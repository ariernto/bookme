<div class="row">
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="number" min="1" name="activity_page_limit_item" value="{{setting_item_with_lang('activity_page_limit_item',request()->query('lang'), 9)}}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="activity_location_search_style" class="form-control">
                            ...
                            <option {{ ($settings['activity_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete from Gmap Place')}}</option>
                        </select>
                    </div>
                </div>
                @endif
        ...
        @include('Activity::admin.settings.form-search')
                                ...
                                @foreach($activity_booking_buyer_fees as $key=>$buyer_fee)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0"  step="0.1"  name="activity_booking_buyer_fees[{{$key}}][price]" class="form-control" value="{{$buyer_fee['price'] ?? ""}}">
                                                <select name="activity_booking_buyer_fees[{{$key}}][unit]" class="form-control">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"  __name__="activity_booking_buyer_fees[__number__][price]" class="form-control" value="">
                                        <select __name__="activity_booking_buyer_fees[__number__][unit]" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Activity create by vendor must be approved by admin?")}}</label>
                        <div class="form-controls">
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                        <label><input type="checkbox" name="activity_deposit_enable" value="1" @if(setting_item('activity_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}</label>
                    </div>
                </div>
                <div class="form-group" data-condition="activity_deposit_enable:is(1)">
                    <label >{{__('Deposit Amount')}}</label>
                    <div class="form-controls">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <input type="number" name="activity_deposit_amount" class="form-control" step="0.1" value="{{old('activity_deposit_amount',setting_item('activity_deposit_amount'))}}" >
                                    <select name="activity_deposit_type"  class="form-control">
                                        <option value="fixed">{{__("Fixed")}}</option>
                                        <option @if(old('activity_deposit_type',setting_item('activity_deposit_type')) == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group" data-condition="activity_deposit_enable:is(1)">
                    ...
                    <div class="form-controls">
                        <div class="row">
                            <div class="col-md-6">
                                <select name="activity_deposit_fomular" class="form-control" >
                                    <option value="default" {{($settings['activity_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                    <option value="deposit_and_fee" {{ ($settings['activity_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                </select>
                            </div>
                        </div>
                    </div>

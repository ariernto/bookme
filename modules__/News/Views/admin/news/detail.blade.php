    ...
    <form action="{{route('news.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post" class="dungdt-form">
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    @if($row->slug)
                        <a class="btn btn-danger btn-sm rounded" href="{{$row->getDetailUrl(request()->query('lang'))}}" target="_blank">{{__("View Post")}}</a>
                    @endif
                </div>
            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <button class="btn btn-danger rounded" type="submit"><i class="fa fa-save"></i> {{__('Save Changes')}}</button>
                                </div>
                            </div>
                        </div>

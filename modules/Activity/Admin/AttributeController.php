...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'activity');
        ...
        return view('Activity::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'activity')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Activity'),
        ...
        return view('Activity::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Activity::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/activity/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Activity::admin.terms.detail', $data);
    }

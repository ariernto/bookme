            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3">
                        @include('Activity::frontend.layouts.details.vendor')
                        @include('Activity::frontend.layouts.details.activity-form-book')
                        @include('Activity::frontend.layouts.details.open-hours')
                    </div>
                </div>
                <div class="row end_activity_sticky">
                    <div class="col-md-12">
                        @include('Activity::frontend.layouts.details.activity-related')
                    </div>
                </div>
            </div>
        </div>
        <div class="bravo-more-book-mobile">
            <div class="container">
                <div class="left">
                    ...
                    @if(setting_item('activity_enable_review'))
                    <?php
                    $reviewData = $row->getScoreReview();
                    $score_total = $reviewData['score_total'];
                    ?>
                    <div class="service-review activity-review-{{$score_total}}">
                        <div class="list-star">
...
@section('footer')
    ...
    <script>
        ...
        var bravo_booking_i18n = {
                ...
                load_dates_url:'{{route('activity.vendor.availability.loadDates')}}',

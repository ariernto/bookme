...
@section('content')
    <div class="bravo_search_activity">
        <h1 class="d-none">
            {{setting_item_with_lang("activity_page_search_title")}}
        </h1>
        <div class="bravo_form_search_map">
            @include('Activity::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map">
            ...
            <div class="results_item">
                @include('Activity::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Activity::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script type="text/javascript" src="{{ asset('module/activity/js/activity-map.js?_ver='.config('app.version')) }}"></script>
@endsection
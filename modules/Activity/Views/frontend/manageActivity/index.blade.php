...
@section('content')
    <h2 class="title-bar">
        {{!empty($recovery) ?__('Recovery Activities') : __("Manage Activities")}}
        @if(Auth::user()->hasPermissionTo('activity_create') && empty($recovery))
        ...
        <div class="bravo-list-item">
            ...
            <div class="list-item">
                <div class="row">
                    @foreach($rows as $row)
                        <div class="col-md-12">
                            @include('Activity::frontend.manageActivity.loop-list')
                        </div>
                    @endforeach
                </div>
            </div>

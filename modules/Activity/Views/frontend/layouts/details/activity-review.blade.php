            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('review.store') }}" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        ...
                        @if($activity_review_stats = setting_item("activity_review_stats"))
                            @php $activity_review_stats = json_decode($activity_review_stats) @endphp
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group review-items">
                                    @foreach($activity_review_stats as $item)
                                        <div class="item">
                    ...
                    <div class="text-center">
                        ...
                        <input type="hidden" name="review_service_type" value="activity">

<div class="bravo_single_book_wrap @if(setting_item('activity_enable_inbox')) has-vendor-box @endif">
    <div class="bravo_single_book">
        <div id="bravo_activity_book_app" v-cloak>
            @if($row->discount_percent)
                <div class="activity-sale-box">
...
@include("Booking::frontend.global.enquiry-form",['service_type'=>'activity'])

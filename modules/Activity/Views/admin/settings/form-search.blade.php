            ...
            <div class="form-group" >
                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            @php
                            $activity_search_fields = setting_item_array('activity_search_fields');
                            $types = [
                            ...
                            @endphp
                            @foreach($activity_search_fields as $key=>$item)
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="activity_search_fields[{{$key}}][title{{$key_lang}}]" value="{{$item['title'.$key_lang] ?? ''}}" class="form-control">
                                                    </div>
                                                @endforeach
                                            @else
                                                <input type="text" name="activity_search_fields[{{$key}}][title]" value="{{$item['title']}}" class="form-control">
                                            @endif
                                            <select name="activity_search_fields[{{$key}}][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="activity_search_fields[{{$key}}][size]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="activity_search_fields[{{$key}}][position]" min="0" value="{{$item['position'] ?? 0}}" class="form-control">
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" __name__="activity_search_fields[__number__][title]" value="" class="form-control">
                                        <select __name__="activity_search_fields[__number__][field]" class="custom-select">
                                            <option value="">{{__("-- Select field type --")}}</option>
                                            @foreach($types as $type=>$name)
                                        ...
                                        <br>
                                        <select __name__="activity_search_fields[__number__][size]" class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="activity_search_fields[__number__][position]" min="0"  class="form-control">
                                    </div>
                                    <div class="col-md-1">
                                        <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                    </div>

...
class CreateActivityDatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        // Schema::table('bravo_activities', function (Blueprint $table) {
        //     $table->tinyInteger('default_state')->default(1)->nullable();
        // });
        Schema::create('bravo_activity_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_activity_dates');
    }
}

...
<head>
    ...
    <link href="{{ asset('dist/frontend/css/footer.css')}}" rel="stylesheet">

    <link href="{{ asset('dist/frontend/css/tourdetail.css')}}" rel="stylesheet">

    <link href="{{ asset('dist/frontend/css/searchbar.css')}}" rel="stylesheet">

<div class="bravo_filter">
    <form action="{{url(app_get_locale(false,false,'/').config('accommodation.accommodation_route_prefix'))}}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($accommodation_min_max_price[0]) );
                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($accommodation_min_max_price[1]) );

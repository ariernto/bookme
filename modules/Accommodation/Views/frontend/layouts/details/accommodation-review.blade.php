@if(setting_item("accommodation_enable_review"))
                ...
                <div class="form-wrapper">
                    ...
                    <form action="{{ route('review.store') }}" class="needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            ...
                            @if($tour_review_stats = setting_item("accommodation_review_stats"))
                        ...
                        <div class="text-center">
                            ...
                            <input type="hidden" name="review_service_type" value="accommodation">

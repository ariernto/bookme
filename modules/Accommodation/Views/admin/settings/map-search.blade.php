                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @endphp
                            @foreach($accommodation_map_search_fields as $key=>$item)
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <select name="accommodation_map_search_fields[{{$key}}][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="accommodation_map_search_fields[{{$key}}][attr]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="accommodation_map_search_fields[{{$key}}][position]" min="0" value="{{$item['position'] ?? 0}}" class="form-control">
                                        </div>
                                        <div class="col-md-1">

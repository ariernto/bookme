...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'accommodation');
        ...
        return view('Accommodation::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'accommodation')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Accommodation'),
        ...
        return view('Accommodation::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Accommodation::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/accommodation/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Accommodation::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('accommodation');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('accommodation',$q);

...
class CreateAccommodationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_accommodations', function (Blueprint $table) {
        ...
        Schema::create('bravo_accommodation_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_accommodation_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_accommodation_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_accommodations');
        Schema::dropIfExists('bravo_accommodation_translations');
        Schema::dropIfExists('bravo_accommodation_term');
        Schema::dropIfExists('bravo_accommodation_dates');
    }
}

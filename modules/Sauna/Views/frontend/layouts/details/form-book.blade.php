<div class="bravo_single_book_wrap @if(setting_item('sauna_enable_inbox')) has-vendor-box @endif">
...
@include("Booking::frontend.global.enquiry-form",['service_type'=>'sauna'])

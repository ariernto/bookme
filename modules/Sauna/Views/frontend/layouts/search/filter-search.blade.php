<div class="bravo_filter">
    <form action="{{url(app_get_locale(false,false,'/').env('SAUNA_ROUTE_PREFIX','sauna'))}}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($sauna_min_max_price[0]) );
                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($sauna_min_max_price[1]) );

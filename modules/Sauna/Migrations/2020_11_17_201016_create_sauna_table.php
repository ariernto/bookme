...
class CreateSaunaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bravo_saunas', function (Blueprint $table) {
        ...
        Schema::create('bravo_sauna_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_sauna_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_sauna_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_saunas');
        Schema::dropIfExists('bravo_sauna_translations');
        Schema::dropIfExists('bravo_sauna_term');
        Schema::dropIfExists('bravo_sauna_dates');
    }
}

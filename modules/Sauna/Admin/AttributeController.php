...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'sauna');
        ...
        return view('Sauna::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'Sauna')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Sauna'),
        ...
        return view('Sauna::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Sauna::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('sauna.admin.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
        ...
        return view('Sauna::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('Sauna');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('Sauna',$q);

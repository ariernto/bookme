                ...
                <div class="panel shadow">
                    ...
                    <div class="panel-body">
                        <form action="{{route('news.admin.category.store',['id'=>-1])}}" method="post">
                            ...
                            <div class="">
                                <button class="btn btn-danger" type="submit"> {{ __('Add new')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/news/category/')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            @csrf
                            <input type="text" name="s" placeholder="{{__('Search Category')}}" value="{{ Request()->s }}" class="form-control">
                            {{-- <button class="btn-danger btn btn-icon btn_search" id="search-submit" type="submit">{{__('Search Category')}}</button> --}}
                        </form>
                    </div>
                </div>
                <div class="panel shadow">

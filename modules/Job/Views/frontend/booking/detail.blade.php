...
<div class="booking-review">
	...
	<div class="booking-review-content">
		...
		<div class="review-section total-review">
			...
			<ul class="review-list">
				@php $rooms = \Modules\Job\Models\HotelRoomBooking::getByBookingId($booking->id) @endphp
				@if(!empty($rooms))
					...
					@foreach($rooms as $room)
						<li class="mb-3 pb-1 border-bottom">
							...
							@if(!empty($dateDetail[$room->room_id]))
								<div>
									@includeIf("Job::frontend.booking.detail-room",['roomDate'=>$dateDetail[$room->room_id]])
								</div>
							@endif

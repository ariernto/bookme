<div class="row">
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="" >{{__("Layout Item Job In Page Search")}}</label>
                            <div class="form-controls">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="hotel_location_search_style" class="form-control">
                            ...
                            <option {{ ($settings['hotel_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete from Gmap Place')}}</option>
                        </select>
                    </div>
                </div>
                @endif
        ...
        @include('Job::admin.settings.form-search')
        @include('Job::admin.settings.map-search')
        <div class="panel">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for Job?")}}</label>
                        <div class="form-controls">

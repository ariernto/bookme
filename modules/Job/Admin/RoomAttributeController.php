...
class RoomAttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Job::admin.room.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Job::admin.room.attribute.detail', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/hotel/room/attribute/terms/' . $row->attr_id
                ],
                [

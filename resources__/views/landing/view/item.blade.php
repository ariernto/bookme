<div class="{{$demo['class'] ?? 'col-lg-4 col-md-6 col-sm-6'}}">
    <div class="item">
        ...
        <h4 onclick="window.open('{{$demo['url']}}')"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 26 9" style="enable-background:new 0 0 26 9;" xml:space="preserve">
